...
class ComboKernel(Kernel):
    ...
    class SequentialDispatch:
        ...
        @classmethod
        def _calculate_xblocks(cls, kernel: "ComboKernel", code: IndentedBuffer):
    ...
    def create_triton_kernel(
        *groups, index_dtype: str, mutations: Set[str], reduction_hint: ReductionHint
    ) -> TritonKernel:
        return TritonKernel(
            *groups,
    ...
    def codegen_kernel_benchmark(
        self, num_gb: float, grid: Optional[List[int]] = None
    ) -> IndentedBuffer:
